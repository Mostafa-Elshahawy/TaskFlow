...
public class GetTasksQueryHandler(ILogger<GetTasksQueryHandler> logger, IMapper mapper, ITaskRepository taskRepository) : IRequestHandler<GetTasksQuery, List<TaskDto>>
{
